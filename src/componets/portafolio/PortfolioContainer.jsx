...
// Asegúrate de que este nombre coincida EXACTAMENTE con el archivo.
import ProyectoModulo2 from './PortafolioModulo2';// Objeto que me sirve de diccionario para mapear nombres a componentes.
// Si elijo 'calculadora', obtengo el componente ProyectoModulo1.
// ...
const projectMap = {
  'calculadora': ProyectoModulo1,
  'lista-tareas': ProyectoModulo2, // <-- NUEVA LÍNEA
...
function PortfolioContainer() {
  ...
  return (
    ...
    {/* Botón para la Lista de Tareas */}
    <button onClick={() => setActiveProject('lista-tareas')}> {/* <-- NUEVO BOTÓN */}
      Lista de Tareas
    </button>
